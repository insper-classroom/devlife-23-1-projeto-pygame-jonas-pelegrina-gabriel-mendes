...
retangulo_a = image.load('game2/assets/img/retangulo_a.png')
retangulo_b = image.load('game2/assets/img/retangulo_b.png')
retangulo_c = image.load('game2/assets/img/retangulo_c.png')
retangulo_d = image.load('game2/assets/img/retangulo_d.png')
...
perdeu = image.load('game2/assets/img/perdeu.png')
...
mixer.music.load('game2/assets/sons/fundo.mp3')
success = mixer.Sound('game2/assets/sons/success.mp3')
fail = mixer.Sound('game2/assets/sons/fail.mp3')
win = mixer.Sound('game2/assets/sons/win.mp3')