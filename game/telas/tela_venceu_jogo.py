...
class TelaVenceuJogo:
    def __init__(self):
        ...
        self.mensagem = fonte_jogo.render('Parabéns, você venceu o jogo!', True, LARANJA)
        ...
        # Cria botões
        self.botao_jogar_novamente = Botao(x, y, largura, altura, ROXO)
        self.botao_menu_principal = Botao(x, y + 80, largura, altura, ROXO)
        self.botao_sair = Botao(WIDTH/2 - 120/2, y + 160, 120, altura, ROXO)
    ...
    def desenha(self, window):
        ...
        window.blit(self.ganhou, (WIDTH/2 - self.ganhou.get_width()/2, HEIGHT/2 - self.ganhou.get_height()/2 - 180))
